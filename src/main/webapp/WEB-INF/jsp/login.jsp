...
<body>
	<form class="form-horizontal" action="${pageContext.request.contextPath}/user/login.do" method="post" onsubmit="check();">
		<div class="form-group">
			<label for="username" name="username" class="col-sm-2 required">用户名：</label>
			<div class="col-md-6 col-sm-10">
				<input type="text" id="username" class="form-control" placeholder="用户名：" name="username" id="username"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-10">
				<input type="password" id="password" class="form-control" placeholder="密码：" name="password" id="password"/>
			</div>
		</div>
